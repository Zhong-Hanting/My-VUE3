...
const init=(()=>{
             ...
             const ambientLight = new THREE.AmbientLight(0x999999) // 创建环境光
            scene.add(ambientLight) // 将环境光添加到场景
            // 点光源
            let pointLight = new THREE.PointLight(0x999999);
            scene.add(pointLight) // 将环境光添加到场景
            var spotLight = new THREE.SpotLight(0x444444);
            // 设置聚光光源位置
            spotLight.position.set(500,500, 50);
...
const loadModel=(()=>{
    ...
    loader.load(
        'static/3Dmodel/city/scene.gltf',(gltf)=>{
            // public\static\3Dmodel\city\scene.gltf
            // D:\开发\MyProject\My-VUE3\src\views\allMenu\threejsDemo\threejsDemo.vue
            //  '../../../../../static/3Dmodel/city/scene.gltf',(gltf)=>{
            gltf.scene.scale.set(100,100,100);
            gltf.scene.rotation.set(0,0,0);
            gltf.scene.position.set(500,110,500);
              console.log(gltf)
